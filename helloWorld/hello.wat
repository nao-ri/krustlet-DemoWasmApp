(module
  ...
  (import "wasi_snapshot_preview1" "poll_oneoff" (func $__imported_wasi_snapshot_preview1_poll_oneoff (type 5)))
  ...
  (func $clock_nanosleep (type 5) (param i32 i32 i32 i32) (result i32)
  ...
  (func $__wasi_fd_write (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    i32.const 65535
    i32.and)
  (func $__wasi_poll_oneoff (type 5) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
